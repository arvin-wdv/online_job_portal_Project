					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Konapara <br/> Jatrabari <br/>Dhaka</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:jobify.2@gmail.com">jobify.2@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+8801612296908">+8801612296908</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Jobify Jobs</h5>
											<p>Jobify Jobs is a job portal, online job management system developed by Nathaniel Nkrumah for his project in february 2025</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Jobify Jobs Contact</h5>
								
								<p>Address : Konapara Jatrabari Dhaka 1362</p>
								<p>Email : <a href="mailto:jobify.2@gmail.com">jobify.2@gmail.com</a></p>
								<p>Phone : <a href="tel:01612296908">01612296908</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Jobify Vision Software</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Arvin Khan</a></li>
								</ul>
